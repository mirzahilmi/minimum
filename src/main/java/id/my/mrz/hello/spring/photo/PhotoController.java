...
public final class PhotoController {
  ...
  @PostMapping("/")
  public PhotoResponse postPhoto(@RequestPart(name = "attachment") MultipartFile photoFile)
      throws IOException {
    PhotoCreateRequest photo =
        new PhotoCreateRequest(photoFile.getOriginalFilename(), photoFile.getBytes());
