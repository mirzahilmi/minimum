    ...
    List<ArticleResourceResponse> articles =
        List.of(
            new ArticleResourceResponse(
                ...
                "kangkung.png",
                tags),
            new ArticleResourceResponse(2L, "Mie Ayam", "mie-ayam", "Mie Ayam", "mie.png", tags));
  ...
  void Create_article_returns_created_status() throws Exception {
    ArticleCreateRequest request =
        new ArticleCreateRequest(
            "Test Article", "test-article", "Test Content", List.of(new TagCreateRequest("test")));
    ...
    ResponseEntity<ArticleResourceResponse> response = controller.postArticle(principal, request);
